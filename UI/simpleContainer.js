export default class SimpleContainer extends Phaser.GameObjects.Container {
    ...
    * @param {Phaser.GameObjects.GameObject} gameObject - objeto que se quiere comprobar
    ...
    * @param {Phaser.GameObjects.GameObject} gameObject - objeto cuya posicion guardar
    */
    ...
    * @param {Phaser.GameObjects.GameObject} gameObject - objeto cuya posicion borrar
    */
    ...
    * @param {Phaser.GameObjects.GameObject} gameObject - objeto cuya posicion reiniciar
    */
